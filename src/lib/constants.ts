...
// Horizontal scrollable categories (for big e-commerce)
export const scrollableCategories = [
  ...
  { id: "baby", name: "Baby", icon: "🍼", color: "bg-sky-100 text-sky-600" },
  {
    id: "automotive",
    name: "Auto",
    icon: "🚗",
  ...
  { id: "pet", name: "Pets", icon: "🐕", color: "bg-amber-100 text-amber-600" },
  {
    id: "grocery",
    name: "Grocery",
    icon: "🛒",
