    ...
    <LiveDisplayShell
      ...
      subtitle={
        phase === "entry_collection"
          ? "Entries are open!"
          : phase === "entries_closed"
            ? "Entries closed - Draw starting soon!"
            : "🏆 Winner Revealed! 🏆"
      }
    ...
    >
      ...
      {phase === "winner_reveal" && finalWinner && (
        <div className="space-y-4">
          {/* Grand Prize */}
          <Card
            className={`bg-gradient-to-r from-yellow-500/20 to-orange-500/20 border-yellow-500/50 ${shufflingNames ? "animate-shake" : "animate-confetti"}`}
          >
            <CardContent className="py-8 text-center">
              {shufflingNames ? (
                ...
                <>
                  ...
                  <p className="text-sm text-yellow-500 uppercase tracking-wider">
                    Grand Prize Winner
                  </p>
      ...
      <style jsx>{`
        ...
        .animate-confetti {
          background-image:
            radial-gradient(circle at 20% 30%, yellow 1px, transparent 1px),
