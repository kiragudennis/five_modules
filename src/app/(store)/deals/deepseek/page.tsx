      ...
      <div className="max-w-4xl mx-auto">
        ...
        {status && status.is_active && (
          <Card
            ...
            style={{
              borderColor:
                status.urgency_level.color === "red" ? "#ef4444" : "#e5e7eb",
            }}
          >
          ...
          <Card className="mb-6 bg-gradient-to-r from-gray-800 to-gray-900 text-white">
            <CardContent className="pt-6 text-center">
              ...
              <p className="text-sm text-gray-300 mb-4">
                Spend {deal.points_to_revive} points to revive it for{" "}
                {deal.revive_duration_minutes} minutes
              </p>
              <Button
              ...
              >
                ...
                {reviving
                  ? "Reviving..."
                  : `Revive for ${deal.points_to_revive} pts`}
              </Button>
            </CardContent>
          </Card>
        )}
            ...
            <Card className="mb-6 bg-gradient-to-r from-purple-600 to-pink-600 text-white">
              <CardContent className="pt-6 text-center">
                ...
                <p className="text-sm mb-4">
                  Be the first to claim this deal by spending{" "}
                  {deal.points_required_for_early_access} points
                </p>
                <Button
                ...
                >
                  ...
                  {gettingEarlyAccess
                    ? "Processing..."
                    : `Get Early Access (${deal.points_required_for_early_access} pts)`}
                </Button>
              </CardContent>
            </Card>
          )}
              ...
              <div>
                ...
                {deal.bonus_points_per_purchase > 0 && (
                  <div className="mb-4 flex items-center gap-2 text-sm text-yellow-600">
                    ...
                    <span>
                      Earn {deal.bonus_points_per_purchase} bonus points on
                      purchase!
                    </span>
                  </div>
                )}
                ...
                {status && (
                  <div className="mb-4 text-sm text-muted-foreground">
                    {status.user_claims_count} / {deal.per_user_limit} claimed
                    per user
                  </div>
                )}
                ...
                >
                  {!status?.can_claim ? (
                    status?.user_claims_count &&
                    status?.user_claims_count >= deal.per_user_limit ? (
                      "Limit Reached"
                    ) : (
                      "Deal Unavailable"
                    )
