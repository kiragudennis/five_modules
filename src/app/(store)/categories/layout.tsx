...
export const metadata: Metadata = {
  title: {
    default: "Lighting Categories | Blessed Two Electricals Nairobi",
  ...
  openGraph: {
    type: "website",
    locale: "en_KE",
    url: "https://www.blessedtwoelectricals.com/categories",
    title: "Lighting Categories | Blessed Two Electricals",
    description:
      "Browse all lighting categories and solutions available at Blessed Two Electricals.",
    images: [
      {
        url: "/categories/og-image.jpg",
        width: 1200,
        height: 630,
        alt: "Lighting Categories at Blessed Two Electricals",
      },
    ],
  },
  twitter: {
