...
// This is the admin page for creating and managing challenges.
// It shows a list of existing challenges with their status and allows creating new ones or editing existing ones in a dialog form.
"use client";
      ...
      <div className="flex justify-between items-center mb-8">
        <div>
          ...
          <p className="text-muted-foreground">
            Create competitions that drive engagement
          </p>
        </div>
              ...
              <div className="flex justify-between items-start">
                ...
                <div className="flex gap-2">
                  <Button
                    ...
                    size="sm"
                    onClick={() =>
                      window.open(`/challenges/live/${challenge.id}`, "_blank")
                    }
                  >
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div>
                  ...
                  <p className="font-medium">
                    {challenge.prize_tiers.length} ranks
                  </p>
                </div>
                <div>
                  <p className="text-sm text-muted-foreground">Teams</p>
                  <p className="font-medium">
                    {challenge.allow_teams ? "Allowed" : "Individual only"}
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-2 mt-6">
                ...
                {(challenge.status === "active" ||
                  ...
                  <Button
                    size="sm"
                    variant="destructive"
                    onClick={() => updateChallengeStatus(challenge.id, "ended")}
                  >
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    updateScoringConfig("min_spend", parseFloat(e.target.value))
                  }
                />
              </div>
            </div>
                ...
                <Label className="flex items-center gap-2">
                  <input
                    ...
                    onChange={(e) =>
                      setFormData({
                        ...formData,
                        streak_reset_on_miss: e.target.checked,
                      })
                    }
                  />
            ...
            {formData.prize_tiers.map((tier: any, idx: number) => (
              <div key={idx} className="flex gap-3 items-center">
                ...
                <select
                  ...
                  onChange={(e) =>
                    updatePrizeTier(idx, "prize_type", e.target.value)
                  }
