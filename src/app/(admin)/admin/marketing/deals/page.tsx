...
export default function DealsAdmin() {
  ...
  const getStatusBadge = (status: string, deal: Deal) => {
    ...
    if (status === "active") {
      if (now < start) return <Badge variant="destructive">Scheduled</Badge>;
      ...
      <div className="flex justify-between items-center mb-8">
        <div>
          ...
          <p className="text-muted-foreground">
            Manage flash sales, BOGO offers, and daily deals
          </p>
        </div>
            ...
            <CardContent className="space-y-4">
              ...
              {deal.deal_type === "bogo" && deal.bogo_config && (
                <div className="text-sm">
                  <span className="text-muted-foreground">
                    Buy {deal.bogo_config.buy_quantity},{" "}
                  </span>
                  <span className="font-bold">
                    Get {deal.bogo_config.get_quantity} FREE
                  </span>
                </div>
              )}
              ...
              {deal.deal_type === "flash_sale" && (
                <div className="flex justify-between text-sm">
                  ...
                  <span
                    className={
                      deal.remaining_quantity === 0 ? "text-red-600" : ""
                    }
                  >
              ...
              <div className="flex gap-2 pt-2">
                <Button
                  ...
                  className="flex-1"
                  onClick={() =>
                    window.open(`/deals/live/${deal.id}`, "_blank")
                  }
                >
